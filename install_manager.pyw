...
class PDFIndexerApp:
    ...
    def setup_ui(self):
        ...
        tk.Checkbutton(opt, text="오류 발생 시 자동 재시작 (Auto-Recovery)", variable=self.var_auto_restart, bg="#fdfefe", fg="#e67e22", font=("Malgun Gothic", 9, "bold")).pack(anchor="w")
...
'''
            ...
            messagebox.showinfo("설치 성공", f"설치가 완료되었습니다!\n\n[{target}]\n폴더 안의 '실행하기(무중단).vbs' 또는 RUN_INDEXER.bat 를 실행하세요.")
            self.root.quit()
